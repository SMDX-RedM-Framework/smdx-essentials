...
RegisterNetEvent('smdx-log:server:CreateLog', function(name, title, color, message, tagEveryone)
...
SMDXCore.Commands.Add('testwebhook', Lang:t('log.test_your_discord_webhook'), {}, false, function()
    TriggerEvent('smdx-log:server:CreateLog', 'testwebhook', Lang:t('log.test_webhook'), 'default', Lang:t('log.webhook_setup_successfully'))
end, 'god')
