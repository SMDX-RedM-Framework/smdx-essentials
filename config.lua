...
ConsumeablesDrink = {
    ...
    ["coffee"] = math.random(10, 25),
    ["beer"] = math.random(10, 15),
    ["whiskey"] = math.random(2, 4),
}
...
Config.Discord = {
    ...
    ["discord_small_image"]     = "wood-sign-3d-render-transparency-png",
}

-- discord webhook config
Config.DiscordWHImage = ''
Config.DiscordWHLogUserName = 'RedM Server Logz'
Config.DiscordWHAuthorName = 'SMDX Development'
