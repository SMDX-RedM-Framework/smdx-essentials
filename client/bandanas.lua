...
RegisterNetEvent('smdx-bandana:client:ToggleBandana')
AddEventHandler('smdx-bandana:client:ToggleBandana', function()
    local ped = PlayerPedId()
    local male = IsPedMale(ped)
    local neckwear = exports['smdx-clothes']:GetClothesCurrentComponentHash('neckwear')

    -- Beard of Power: https://www.nexusmods.com/skyrimspecialedition/mods/42635
    -- local beardofpower = exports['smdx-appearance']:GetBodyCurrentComponentHash('beard')
